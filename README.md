...
For example, such possibility can occur if Token is on same line as ending of multiline string literal.
Describbed cases are not considered to be supported as the main goal is to keep extension fast in execution.
```
